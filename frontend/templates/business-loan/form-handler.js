// Fidenta.io deployment pending: API will move to https://fidenta.netlify.app
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const API_URL = window.location.hostname === 'localhost' 
        ? 'https://fidenta.netlify.app/api/leads'
        : 'https://fidenta.netlify.app/api/leads';
...
window.testLeadSubmission = async function() {
    ...
    try {
        const response = await fetch('https://fidenta.netlify.app/api/leads', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
